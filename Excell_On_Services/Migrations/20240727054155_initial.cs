        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Contact_Subject = table.Column<string>(type: "varchar(100)", nullable: false),
                    Contact_Message = table.Column<string>(type: "varchar(250)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceChargesPerMonth = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ClientServices_Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Client_Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ClientServices_Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ClientServices_Duration = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClientService_AspNetUsers_Client_Id",
                        column: x => x.Client_Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClientService_Service_Services_Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientService_Client_Id",
                table: "ClientService",
                column: "Client_Id");

            migrationBuilder.CreateIndex(
                name: "IX_ClientService_Services_Id",
                table: "ClientService",
                column: "Services_Id");
        }
